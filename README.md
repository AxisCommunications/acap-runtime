...
### TLS
The ACAP runtime service can be run either unsecured or in TLS mode. TLS mode provides additional security and encryption on the gRPC channel. This is further described in [Use TLS](#use-tls)
...
* Certificate files if [TLS](#use-tls) is used.
...
[axisecp/acap-runtime](https://hub.docker.com/r/axisecp/acap-runtime) with tags on the form \<version>-\<ARCH>-containerized.
...
## Contributing
- [ ] TODO: Do we have a template/link for this.

----------------------


## Use TLS
- [ ] TODO: Move to better location in the document
